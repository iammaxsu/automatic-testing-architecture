...
$_date1 = Get-Date -Format 'yyyy-MM-ddTHH:mm:ss'    # ISO 8601 extended, local (LOG022): content/JSON
$_date2 = Get-Date -Format 'yyyyMMddTHHmmss'         # ISO 8601 basic, local (LOG022): filenames
